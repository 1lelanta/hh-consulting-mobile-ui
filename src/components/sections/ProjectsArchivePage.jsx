    ...
    >
      <div className="mx-auto w-full max-w-[1320px]">
        ...
        <motion.div
          ...
          className="relative mt-12 overflow-visible rounded-none border border-[#D5B223]/35 bg-[linear-gradient(130deg,#081223_0%,#111827_58%,#1f2937_100%)] px-6 py-8 text-white shadow-[0_22px_46px_rgba(2,6,23,0.3)] sm:px-8 sm:py-9"
        >
          ...
          <p className="m-0 text-[1.38rem] font-bold leading-tight sm:text-[1.58rem]">Ready to move your project forward?</p>
          <p className="m-0 mt-3 max-w-[70ch] text-[1rem] leading-7 text-[#E5E7EB]">
